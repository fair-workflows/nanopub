...
keys_folder = TEST_RESOURCES_FILEPATH
# keys_folder = os.path.join(str(Path(__file__).parent.resolve()), "resources")

profile_yaml = f"""orcid_id: https://orcid.org/0000-0000-0000-0000
name: Nanopub python test user
public_key: {keys_folder}/id_rsa.pub
private_key: {keys_folder}/id_rsa
