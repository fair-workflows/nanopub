...
#     with patch('nanopub.__main__.USER_CONFIG_DIR', nanopub_path), \
#             patch('nanopub.__main__.DEFAULT_PUBLIC_KEY_PATH', new_public_keyfile), \
#             patch('nanopub.__main__.DEFAULT_PRIVATE_KEY_PATH', new_private_keyfile), \
#             patch('nanopub.profile.PROFILE_PATH', nanopub_path / 'profile.yml'), \
#             patch('nanopub.__main__.NanopubClient.publish') as mocked_client_publish:
#         __main__.cli(
...
#     with patch(
#             'nanopub.__main__.USER_CONFIG_DIR',
#             nanopub_path), \
#          patch(
#             'nanopub.__main__.DEFAULT_PUBLIC_KEY_PATH',
#             new_public_keyfile), \
#          patch(
#             'nanopub.__main__.DEFAULT_PRIVATE_KEY_PATH',
#             new_private_keyfile), \
#          patch(
#             'nanopub.__main__.DEFAULT_KEYS_PATH_PREFIX',
